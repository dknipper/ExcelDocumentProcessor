...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			$("#"+$.jgrid.jqID(pgid) )
			.append("<div id='"+pgcnt+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='"+lft+"' align='left'></td>" +
		        "<td id='"+cent+"' align='center' style='white-space:pre;'></td>" +
                "<td id='"+rgt+"' align='right'></td></tr></tbody></table></div>")
			...
			$('.ui-pg-selbox', "#" + pgcnt).bind('change', function () {
			    if (!clearVals('records') || this.value === "-1") { return false; } // tk - added to allow "All" to function properly
			...
			var triggerToolbar = function() {
				...
				$.each($t.p.colModel, function () {
					...
					v = this.stype === "custom" && $.isFunction(this.searchoptions.custom_value) && $elem.length > 0 && $elem[0].nodeName.toUpperCase() === "SPAN" ?
						...
						$elem.val();
					if (v || so === "nu" || so === "nn") {
					    // tk - added logic here to "escape" the comma separators for multiselect.'
					    if ($.type(v) === "array") {
					        v = v.join("C711291D");
					    }
						sdata[nm] = v;
